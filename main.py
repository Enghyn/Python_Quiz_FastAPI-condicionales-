...
# =============================
PROMPT = """
# SYSTEM PROMPT: Generador de preguntas de análisis de código Python CONDICIONALES para exámenes universitarios
...
5. **Genera un código Python autocontenido** que cumpla con los criterios de la sección "Criterios del código". El código debe ser único, claro y adecuado para principiantes, usando condicionales, sin bucles, recursividad ni estructuras de datos complejas.
6. Prohibido ejercicios de recursividad, bucles, manipulación de listas, tuplas, conjuntos o diccionarios.
...
10. **Simula mentalmente la ejecución del código** y verifica paso a paso la lógica, los cálculos y los signos comparadores. No cometas errores lógicos ni de comparación.
...
- Solo ejercicios CONDICIONALES: uso de if, elif, else obligatorio. Prohibido el uso de bucles (for, while), recursividad, funciones definidas por el usuario, y estructuras de datos (listas, tuplas, conjuntos, diccionarios).
...
- Solo operaciones aritméticas, asignaciones, uso de input() (con valor explícito en el enunciado), print(), conversiones de tipo, comparación de valores, operadores lógicos, selección de caminos, y operaciones que mezclen tipos simples.
